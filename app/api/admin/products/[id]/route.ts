    ...
    try {
      product = await queryOne(
        `UPDATE products SET
           ...
           length_cm = $24, width_cm = $25, height_cm = $26, kp_terms_override = $27, featured_specs = $28, questionnaire_url = $29
         WHERE id = $30 RETURNING *`,
        [...baseArgs.slice(0, 15), video_url ?? null, instagram_url ?? null, ...baseArgs.slice(15)],
      )
    } catch (e: unknown) {
      if (e instanceof Error && e.message.includes('instagram_url')) {
        product = await queryOne(
          `UPDATE products SET
             category_id = $1, name_ru = $2, name_kk = $3, name_en = $4, model = $5,
             description_ru = $6, description_kk = $7, description_en = $8,
             ...
             length_cm = $23, width_cm = $24, height_cm = $25, kp_terms_override = $26, featured_specs = $27, questionnaire_url = $28
        ...
        product = await queryOne(
          `UPDATE products SET
             ...
             length_cm = $22, width_cm = $23, height_cm = $24, kp_terms_override = $25, featured_specs = $26, questionnaire_url = $27
