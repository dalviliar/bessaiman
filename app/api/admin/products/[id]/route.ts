    ...
    try {
      product = await queryOne(
        `UPDATE products SET
           ...
           length_cm = $24, width_cm = $25, height_cm = $26, kp_terms_override = $27, featured_specs = $28
      ...
      if (e instanceof Error && e.message.includes('instagram_url')) {
        product = await queryOne(
          `UPDATE products SET
             ...
             length_cm = $23, width_cm = $24, height_cm = $25, kp_terms_override = $26, featured_specs = $27
        ...
        product = await queryOne(
          `UPDATE products SET
             ...
             length_cm = $22, width_cm = $23, height_cm = $24, kp_terms_override = $25, featured_specs = $26
