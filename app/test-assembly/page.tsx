...
export default function TestAssemblyPage() {
  ...
  return (
    <div style={{ background: '#F8FAFC', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="text-center text-xs font-mono py-1.5" style={{ background: '#0F172A', color: '#FBBF24', letterSpacing: 1 }}>
        ТЕСТОВАЯ СТРАНИЦА — НЕ ДЛЯ ПРОДАКШЕНА · копия главной с новым 3D-механизмом
      </div>
