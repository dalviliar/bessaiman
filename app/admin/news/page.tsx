    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.07)' }}>
        {loading ? (
          ...
          <div className="py-12 text-center text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>Постов нет — создайте первый</div>
        ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.7)' }}>
          <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-2xl p-6" style={{ background: '#0D1421', border: '1px solid rgba(255,255,255,0.08)' }}>
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-base font-black text-white">{modal.mode === 'create' ? 'Новый пост' : 'Редактировать'}</h2>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-xs mb-1" style={{ color: 'rgba(255,255,255,0.5)' }}>
                  Ссылка на пост в Instagram <span style={{ color: 'rgba(255,255,255,0.3)' }}>(необязательно)</span>
                </label>
